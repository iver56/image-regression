...
for i in range(img_height):
    for j in range(img_width):
        flat_pixel_vector = [0] * num_pixels
        flat_pixel_vector[img_width * i + j] = 1
        input_vector = flat_pixel_vector# + [i / img_height, j / img_width]
...
model = Sequential()
model.add(Dense(30, input_dim=num_pixels + 0))
